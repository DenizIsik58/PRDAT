# 1 "../Lectures/Lec02/HelloLex/hello2.fsl"
  // starting
...
# 8 "../Lectures/Lec02/HelloLex/hello2.fs"
...
and Tokenize  lexbuf =
  ...
  | 0 -> ( 
# 9 "../Lectures/Lec02/HelloLex/hello2.fsl"
                                        LexBuffer<char>.LexemeString lexbuf 
# 29 "../Lectures/Lec02/HelloLex/hello2.fs"
          )
  | 1 -> ( 
# 10 "../Lectures/Lec02/HelloLex/hello2.fsl"
                                     failwith "Lexer error: illegal symbol" 
# 34 "../Lectures/Lec02/HelloLex/hello2.fs"
          )
  | _ -> failwith "Tokenize"

# 13 "../Lectures/Lec02/HelloLex/hello2.fsl"
  // ending
...
# 3000000 "../Lectures/Lec02/HelloLex/hello2.fs"
