# 1 "../Lectures/Lec02/HelloLex/hello.fsl"
  // starting
...
# 8 "../Lectures/Lec02/HelloLex/hello.fs"
...
and Tokenize  lexbuf =
  ...
  | 0 -> ( 
# 9 "../Lectures/Lec02/HelloLex/hello.fsl"
                                     LexBuffer<char>.LexemeString lexbuf 
# 27 "../Lectures/Lec02/HelloLex/hello.fs"
          )
  | 1 -> ( 
# 10 "../Lectures/Lec02/HelloLex/hello.fsl"
                                     failwith "Lexer error: illegal symbol" 
# 32 "../Lectures/Lec02/HelloLex/hello.fs"
          )
  | _ -> failwith "Tokenize"

# 13 "../Lectures/Lec02/HelloLex/hello.fsl"
  // ending
...
# 3000000 "../Lectures/Lec02/HelloLex/hello.fs"
